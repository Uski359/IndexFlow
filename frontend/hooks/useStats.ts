...
import { getActivityStats, getHolderCount, getSupply, getThroughputStats } from '@/lib/api';
...
export const useStats = () => {
  ...
  const supplySWR = useSWR<SupplyStat>(['supply', chain], () => getSupply(chain), {
