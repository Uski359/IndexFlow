...
export interface IFLWStakingRewardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balances"
      | "earned"
...
export interface IFLWStakingRewards extends BaseContract {
  connect(runner?: ContractRunner | null): IFLWStakingRewards;
  waitForDeployment(): Promise<this>;

  interface: IFLWStakingRewardsInterface;
