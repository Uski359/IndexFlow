...
export interface FoundersVestingInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "LINEAR_VESTING_PERIOD",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface FoundersVesting extends BaseContract {
  connect(runner?: ContractRunner | null): FoundersVesting;
  waitForDeployment(): Promise<this>;

  interface: FoundersVestingInterface;
  ...
  LINEAR_VESTING_PERIOD: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "LINEAR_VESTING_PERIOD"
